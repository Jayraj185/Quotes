        ...
        () => Stack(
          children: [
            Container(
              height: Get.height,
              width: Get.width,
              child: Image.asset("${homeController.ViewImageBackList[homeController.ImageBackIndex.value]}",fit: BoxFit.fill,),
            ),
            Align(
              alignment: Alignment.topCenter,
              child: Padding(
                padding: EdgeInsets.only(right: Get.width/21,left: Get.width/15,top: Get.height/3.5),
                child: Text(
                  "''  ${homeController.QuotesData}  ''",
                  style: homeController.ViewFontList[homeController.FontIndex.value](
                    fontSize: 16.sp,
                    color: Colors.white,
                  ),
                ),
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      icon: Icon(Icons.image,color: Colors.white,size: 21.sp,),
                    ),
                    IconButton(
                      onPressed: () {
                      ...
                      icon: Icon(Icons.hdr_auto_rounded,color: Colors.white,size: 21.sp,),
                    ),
                    IconButton(
                      onPressed: () async {
                        await Clipboard.setData(ClipboardData(text: "${homeController.QuotesData}"));
                        Get.snackbar('Thank You', "This Quotes Is Copied");
                      },
                      icon: Icon(Icons.copy,color: Colors.white,size: 21.sp,),
                    ),
                    IconButton(
                      onPressed: () {
                        Share.share("${homeController.QuotesData}");
                      },
                      icon: Icon(Icons.share,color: Colors.white,size: 21.sp,),
                    ),
                    IconButton(
                      onPressed: () {
                      },
                      icon: Icon(Icons.star,color: Colors.white,size: 21.sp,),
                    ),
                  ],
                ),
              ),
